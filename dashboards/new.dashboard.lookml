- dashboard: 360_marketing_overview
  ...
  - name: "<span class='fa fa-dollar'> Revenue Attribution</span>"
    ...
    body_text: "<center><strong>Recommended Action — </strong> Drill deeper into our\
      \ campaigns with the highest spend to make any necessary adjustments</center>"
    row: 0
    col: 0
    width: 24
    height: 3
  ...
  - title: Highest Spending Campaigns
    ...
    series_column_widths:
      ...
      adevents.total_cost: 130
      session_attribution.ROI: 130
      session_attribution.total_attribution: 130
  ...
  - name: Acquisition Date
    ...
    type: date_filter
    default_value: 2020/11/13 to 2020/11/14
    allow_multiple_values: true
    required: false
    ui_config:
